...
const SERVICE_NAME = process.env.SERVICE_NAME || 'makeup-catalog-service';
const SERVICE_PORT = parseInt(process.env.PORT, 10) || 3001;
...
async function registerWithConsul() {
  try {
    ...
    await axios.put(`${CONSUL_URL}/v1/agent/service/register`, {
      ...
      Name: SERVICE_NAME,
      Port: SERVICE_PORT,
      Tags: ['nodejs', 'express', 'catalog', 'glowflow'],
      Check: {
